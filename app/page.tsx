    ...
    return (
        <div className={`min-h-screen ${theme.bg} ${theme.text}`}>
                ...
                <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-cyan-300 to-purple-300 dark:from-gray-100 dark:via-blue-500 dark:to-purple-900 opacity-25" />
